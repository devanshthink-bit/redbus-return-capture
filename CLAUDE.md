...
- `hifi/app.html` — **the hi-fi prototype: the 31 Figma frames as working code.** Shown *inside*
...
**The hi-fi is 31 screens.** Adding one means four edits, not one: `hifi/src/render.tsx`, the count
