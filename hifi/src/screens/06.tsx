  ...
  return (
    <div className="bg-[var(--surface\/page,#f2f2f7)] content-stretch flex flex-col items-start relative size-full" data-node-id="99:636" data-name="06 · Your return · pick a day">
      <div className="bg-[#fcfcff] content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-node-id="99:637" data-name="Header">
        <div className="content-stretch flex h-[47px] items-center justify-between pb-[8px] pl-[27px] pr-[14px] pt-[18px] relative shrink-0 w-full" data-node-id="99:638" data-name="Status Bar / Light">
        ...
        <div className="h-[63px] relative shrink-0 w-full" data-node-id="99:651" data-name="Nav / Top Bar">
          ...
          <div className="absolute bottom-0 content-stretch flex items-center justify-end right-[8px] top-0 w-[120px]" data-node-id="I99:651;56:226" data-name="Trailing slot">
            <div className="content-stretch flex h-[52px] items-center justify-center px-[10px] relative shrink-0" data-node-id="I99:651;53:196" data-name="Trailing">
              <p className="[word-break:break-word] font-['Inter:Bold'] font-bold leading-[20px] not-italic relative shrink-0 text-[16px] text-[color:var(--text\/button,#e81e38)] whitespace-nowrap" data-node-id="I99:651;53:196;97:644">
                Edit
              </p>
            </div>
          </div>
      ...
      <div className="content-stretch flex flex-col gap-[16px] items-start pb-[149px] pt-[13px] px-[16px] relative shrink-0 w-full" data-node-id="99:661" data-name="Content">
      ...
      <div className="absolute bg-[var(--surface\/default,white)] border-[var(--border\/divider,#e6e6e6)] border-solid border-t bottom-0 content-stretch flex flex-col gap-[12px] items-center left-0 pb-[31px] right-0" data-node-id="99:747" data-name="Action bar">
        <div className="bg-[var(--surface\/accent-faint,#fcf0f0)] content-stretch flex items-start overflow-clip px-[16px] py-[10px] relative shrink-0 w-full" data-node-id="889:4512" data-name="Bar note">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular'] font-normal leading-[16px] min-w-px not-italic relative self-stretch text-[12px] text-[color:var(--text\/secondary,#636363)]" data-node-id="519:3806">
            You choose the bus, seat and stops before you pay. The date can change later, to any day.
          </p>
        </div>
        <div className="content-stretch flex gap-[16px] items-center overflow-clip px-[16px] relative shrink-0 w-full" data-node-id="519:3805" data-name="Action row">
          ...
          <ButtonPrimary className="bg-[var(--surface\/button-primary,#e81e38)] content-stretch drop-shadow-[0px_2px_3px_rgba(0,0,0,0.1)] flex flex-[1_0_0] gap-[10px] h-[48px] items-center min-w-px justify-center px-[20px] relative rounded-[var(--radius\/full,999px)] shrink-0 w-[176px]" label="Review trip" showIcon={false} />
        </div>
      </div>
    </div>
  );
