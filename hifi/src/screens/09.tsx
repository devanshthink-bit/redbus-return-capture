...
const imgIconGift = "assets/dcf0c517-3148-438b-8909-17221bcd8648.svg";
const imgIconGlobe = "assets/5df2ea04-9b1c-4b42-a123-ebe0393efc46.svg";
...
const imgLogo = "assets/3f70cf49-250e-4946-ad8e-eb0a81fac839.png";
const imgLogo1 = "assets/1379ac68-350b-40d8-a546-6d01c8c37c49.png";
const imgLogo2 = "assets/6e249aae-3def-45a8-9c61-f3f3969248fa.png";
const imgLogo3 = "assets/940bd2a8-70d7-4a7f-8b5b-f13cb5f26365.png";
const imgLogo4 = "assets/3ffec73d-e88b-4537-9bc9-c8e79b2a4ef7.png";
...
function IconGift({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[24px]"} data-node-id="672:4015" data-name="Icon / Gift">
      <div className="absolute left-0 size-[24px] top-0" data-node-id="672:4009" data-name="Icon / Gift">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgIconGift} />
      </div>
    </div>
  );
}
...
function IconGlobe({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[24px]"} data-node-id="672:4008" data-name="Icon / Globe">
      <div className="absolute left-0 size-[24px] top-0" data-node-id="672:4002" data-name="Icon / Globe">
...
function ArtCardNetworks({ className }: { className?: string }) {
  return (
    <div className={className || "h-[24px] relative w-[160px]"} data-node-id="673:3998" data-name="Art / Card networks">
      <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgArtCardNetworks} />
    </div>
  );
}
...
function IconCard({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[24px]"} data-node-id="672:4001" data-name="Icon / Card">
      <div className="absolute left-0 size-[24px] top-0" data-node-id="672:3997" data-name="Icon / Card">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgIconCard} />
      </div>
    </div>
  );
}
...
function IconPercentGreen({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[30px]"} data-node-id="108:975" data-name="Icon / Percent green">
      <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgIconPercentGreen} />
    </div>
  );
}
  ...
  return (
    <div className="bg-[var(--surface\/page,#f2f2f7)] content-stretch flex flex-col items-start relative size-full" data-node-id="109:973" data-name="09 · Pay">
      <div className="bg-[#fcfcff] content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-node-id="109:974" data-name="Header">
        <div className="content-stretch flex h-[47px] items-center justify-between pb-[8px] pl-[27px] pr-[14px] pt-[18px] relative shrink-0 w-full" data-node-id="109:975" data-name="Status Bar / Light">
      ...
      <div className="content-stretch flex flex-col gap-[16px] items-start pb-[24px] pt-[20px] px-[16px] relative shrink-0 w-full" data-node-id="109:1020" data-name="Payment">
        ...
        <div className="bg-[var(--surface\/default,white)] content-stretch drop-shadow-[0px_8px_12px_rgba(0,0,0,0.07),0px_2px_3px_rgba(0,0,0,0.05)] flex flex-col items-start p-[16px] relative rounded-[var(--radius\/16,16px)] shrink-0 w-full" data-node-id="673:4005" data-name="Apply Coupon">
          <div className="bg-white content-stretch flex gap-[14px] items-center overflow-clip relative shrink-0 w-full" data-node-id="673:4012" data-name="Row">
            <IconPercentGreen className="relative shrink-0 size-[30px]" />
            <div className="[word-break:break-word] bg-white content-stretch flex flex-[1_0_0] flex-col font-['Inter:Regular'] font-normal gap-[2px] items-start min-w-px not-italic overflow-clip relative" data-node-id="673:4013" data-name="Text">
              <p className="leading-[24px] relative shrink-0 text-[18px] text-[color:var(--text\/primary,#1d1d1d)] w-full" data-node-id="673:4014">
                Apply Coupon
              </p>
              <p className="leading-[21px] relative shrink-0 text-[15px] text-[color:var(--text\/secondary,#636363)] w-full" data-node-id="673:4015">
                Apply now and Save up to Rs 50
              </p>
            </div>
            <IconChevronRight className="relative shrink-0 size-[20px]" />
          </div>
        </div>
        <div className="bg-[var(--surface\/default,white)] content-stretch drop-shadow-[0px_8px_12px_rgba(0,0,0,0.07),0px_2px_3px_rgba(0,0,0,0.05)] flex flex-col items-start p-[16px] relative rounded-[var(--radius\/16,16px)] shrink-0 w-full" data-node-id="673:4019" data-name="Preferred Options">
          <p className="[word-break:break-word] font-['Inter:Bold'] font-bold leading-[26px] not-italic relative shrink-0 text-[20px] text-[color:var(--text\/primary,#1d1d1d)] w-full" data-node-id="673:4026">
            Preferred Options
          </p>
          <div className="h-[6px] relative shrink-0 w-full" data-node-id="673:4027" data-name="gap" />
          <div className="content-stretch flex gap-[16px] items-center py-[14px] relative shrink-0 w-full" data-node-id="673:4028" data-name="Row / Payment method">
            <div className="relative shrink-0 size-[32px]" data-node-id="I673:4028;108:986" data-name="Logo">
        ...
        <div className="bg-[var(--surface\/default,white)] content-stretch drop-shadow-[0px_8px_12px_rgba(0,0,0,0.07),0px_2px_3px_rgba(0,0,0,0.05)] flex flex-col items-start p-[16px] relative rounded-[var(--radius\/16,16px)] shrink-0 w-full" data-node-id="109:1029" data-name="UPI">
          ...
          <div className="bg-[var(--border\/divider,#e6e6e6)] h-px relative shrink-0 w-full" data-node-id="674:4008" data-name="Divider" />
          <div className="content-stretch flex gap-[16px] items-center py-[14px] relative shrink-0 w-full" data-node-id="674:4009" data-name="Row / Payment method">
            <div className="relative shrink-0 size-[32px]" data-node-id="I674:4009;108:986" data-name="Logo">
              <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgLogo3} />
            </div>
            <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular'] font-normal leading-[22px] min-w-px not-italic relative text-[16px] text-[color:var(--text\/primary,#1d1d1d)]" data-node-id="I674:4009;108:987">
              Enter UPI ID
            </p>
            <div className="border-[1.5px] border-[var(--border\/default,#b0b0b0)] border-solid relative rounded-[var(--radius\/full,999px)] shrink-0 size-[24px]" data-node-id="I674:4009;108:988" data-name="Radio" />
          </div>
        </div>
        <div className="bg-[var(--surface\/default,white)] content-stretch drop-shadow-[0px_8px_12px_rgba(0,0,0,0.07),0px_2px_3px_rgba(0,0,0,0.05)] flex flex-col items-start p-[16px] relative rounded-[var(--radius\/16,16px)] shrink-0 w-full" data-node-id="674:4013" data-name="CRED pay">
          <p className="[word-break:break-word] font-['Inter:Bold'] font-bold leading-[26px] not-italic relative shrink-0 text-[20px] text-[color:var(--text\/primary,#1d1d1d)] w-full" data-node-id="674:4020">
            CRED pay
          </p>
          <div className="h-[6px] relative shrink-0 w-full" data-node-id="674:4021" data-name="gap" />
          <div className="bg-white content-stretch flex gap-[16px] items-center overflow-clip py-[14px] relative shrink-0 w-full" data-node-id="675:4040" data-name="Row / Payment method">
            <div className="relative shrink-0 size-[32px]" data-node-id="675:4036" data-name="Logo">
              <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgLogo4} />
            </div>
            <div className="[word-break:break-word] bg-white content-stretch flex flex-[1_0_0] flex-col font-['Inter:Regular'] font-normal gap-[2px] h-[66px] items-start min-w-px not-italic overflow-clip relative" data-node-id="675:4041" data-name="Text">
              <p className="flex-[1_0_0] leading-[22px] min-h-px relative text-[16px] text-[color:var(--text\/primary,#1d1d1d)] w-full" data-node-id="675:4038">
                CRED pay
              </p>
              <p className="leading-[21px] relative shrink-0 text-[#29783d] text-[15px] w-full" data-node-id="675:4039">
                Use your saved cards or UPI for faster payments
              </p>
            </div>
            <div className="border-[1.5px] border-[var(--border\/default,#b0b0b0)] border-solid relative rounded-[var(--radius\/full,999px)] shrink-0 size-[24px]" data-node-id="675:4037" data-name="Radio" />
          </div>
        </div>
        <div className="bg-[var(--surface\/default,white)] content-stretch drop-shadow-[0px_8px_12px_rgba(0,0,0,0.07),0px_2px_3px_rgba(0,0,0,0.05)] flex flex-col items-start p-[16px] relative rounded-[var(--radius\/16,16px)] shrink-0 w-full" data-node-id="674:4027" data-name="Pay using card">
          <p className="[word-break:break-word] font-['Inter:Bold'] font-bold leading-[26px] not-italic relative shrink-0 text-[20px] text-[color:var(--text\/primary,#1d1d1d)] w-full" data-node-id="674:4034">
            Pay using card
          </p>
          <div className="h-[10px] relative shrink-0 w-full" data-node-id="674:4035" data-name="gap" />
          <div className="bg-white content-stretch flex gap-[14px] items-start overflow-clip relative shrink-0 w-full" data-node-id="674:4036" data-name="Row">
            <IconCard className="relative shrink-0 size-[24px]" />
            <div className="bg-white content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px overflow-clip relative" data-node-id="674:4042" data-name="Text">
              <p className="[word-break:break-word] font-['Inter:Regular'] font-normal leading-[24px] min-w-full not-italic relative shrink-0 text-[18px] text-[color:var(--text\/primary,#1d1d1d)] w-[min-content]" data-node-id="674:4043">
                Add credit / debit card
              </p>
              <p className="[word-break:break-word] font-['Inter:Regular'] font-normal leading-[21px] min-w-full not-italic relative shrink-0 text-[15px] text-[color:var(--text\/secondary,#636363)] w-[min-content]" data-node-id="674:4044">
                Visa, Master Card and more
              </p>
              <ArtCardNetworks className="h-[24px] relative shrink-0 w-[160px]" />
            </div>
            <IconChevronRight className="relative shrink-0 size-[20px]" />
          </div>
        </div>
        <div className="bg-[var(--surface\/default,white)] content-stretch drop-shadow-[0px_8px_12px_rgba(0,0,0,0.07),0px_2px_3px_rgba(0,0,0,0.05)] flex flex-col items-start p-[16px] relative rounded-[var(--radius\/16,16px)] shrink-0 w-full" data-node-id="674:4049" data-name="Net banking">
          <p className="[word-break:break-word] font-['Inter:Bold'] font-bold leading-[26px] not-italic relative shrink-0 text-[20px] text-[color:var(--text\/primary,#1d1d1d)] w-full" data-node-id="674:4056">
            Net banking
          </p>
          <div className="h-[10px] relative shrink-0 w-full" data-node-id="674:4057" data-name="gap" />
          <div className="bg-white content-stretch flex gap-[14px] items-center overflow-clip relative shrink-0 w-full" data-node-id="674:4058" data-name="Row">
            <IconGlobe className="relative shrink-0 size-[24px]" />
            <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular'] font-normal leading-[24px] min-w-px not-italic relative text-[18px] text-[color:var(--text\/primary,#1d1d1d)]" data-node-id="674:4066">
              Pay via Net Banking
            </p>
            <IconChevronRight className="relative shrink-0 size-[20px]" />
          </div>
        </div>
        <div className="bg-[var(--surface\/default,white)] content-stretch drop-shadow-[0px_8px_12px_rgba(0,0,0,0.07),0px_2px_3px_rgba(0,0,0,0.05)] flex flex-col items-start p-[16px] relative rounded-[var(--radius\/16,16px)] shrink-0 w-full" data-node-id="674:4070" data-name="Gift card">
          <div className="bg-white content-stretch flex gap-[14px] items-center overflow-clip relative shrink-0 w-full" data-node-id="674:4077" data-name="Row">
            <IconGift className="relative shrink-0 size-[24px]" />
            <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular'] font-normal leading-[24px] min-w-px not-italic relative text-[18px] text-[color:var(--text\/primary,#1d1d1d)]" data-node-id="674:4085">
              Have a redBus gift card?
            </p>
            <IconChevronRight className="relative shrink-0 size-[20px]" />
          </div>
        </div>
