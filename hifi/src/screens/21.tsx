    ...
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-node-id="792:4561" data-name="21 · Filter Buses">
      <div className="bg-white flex-[1_0_0] min-h-px overflow-clip relative w-full" data-node-id="792:4562" data-name="Backdrop">
        <div className="absolute bg-[var(--surface\/default,white)] content-stretch flex flex-col items-start left-0 overflow-clip top-0 w-[390px]" data-node-id="795:6205" data-name="Bus list header · behind">
          <div className="content-stretch flex h-[47px] items-center justify-between pb-[8px] pl-[27px] pr-[14px] pt-[18px] relative shrink-0 w-full" data-node-id="795:6206" data-name="Status Bar / Light">
      ...
      <div className="absolute bg-white content-stretch flex flex-col h-[774px] items-start left-[8px] overflow-clip rounded-bl-[36px] rounded-br-[36px] rounded-tl-[20px] rounded-tr-[20px] top-[62px] w-[374px]" data-node-id="792:4698" data-name="Sheet">
        ...
        <div className="bg-white border-[#e6e6e6] border-solid border-t content-stretch flex gap-[14px] items-center overflow-clip pb-[34px] pt-[14px] px-[16px] relative shrink-0 w-full" data-node-id="792:4743" data-name="Action bar">
          ...
          <ButtonPrimary className="bg-[var(--surface\/button-primary,#e81e38)] content-stretch cursor-pointer flex flex-[1_0_0] gap-[10px] h-[48px] items-center justify-center min-w-px overflow-clip px-[20px] relative rounded-[var(--radius\/full,999px)] shadow-[0px_2px_6px_0px_rgba(0,0,0,0.1)]" label="Apply" showIcon={false} />
        </div>
      </div>
    </div>
  );
