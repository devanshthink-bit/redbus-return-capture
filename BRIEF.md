...
| **v3** | `/v3.html` | *Calendar.* One tap for a fixed date, two for a range; books the **last movable** day and shows the saving. Carries the Idea 9 guard, **day-level movability**, an **auto-assigned return seat and boarding points** changed at Trip review, and a visible change balance |
